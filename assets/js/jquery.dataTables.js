...
(/** @lends <global> */function( $ ) {
	...
	function _fnFeatureHtmlFilter ( settings )
	{
		...
		str = str.match(/_INPUT_/) ?
			...
			str+input; 
                if(window.location.pathname.indexOf('admin/reports.html') != -1 || window.location.pathname.indexOf('admin/reports/tables.html') != -1 || window.location.pathname.indexOf('admin/reports/turnover.html') != -1){
                    str = '<div class="range_section pull-left"><input type="text" id="min" class="form-control input-sm" placeholder="From Date:">'+
                            '<input type="text" id="max" class="form-control input-sm" placeholder="To Date:"></div><div class="pull-right">'+str+'</div>';
