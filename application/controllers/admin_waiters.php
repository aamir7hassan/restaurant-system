    ...
    function edit_waiter($id)
    {
        ...
        if (isset($_POST) && !empty($_POST))
        {
            $data = array(
                ...
                'last_name'  => $this->input->post('last_name'),
                'username'   => strtolower($this->input->post('first_name')),
                'waiter_float'=> (float)$this->input->post('waiter_float'),
		...
		$tempTables						= $this->waiter_model->tempTables($id);
		...
		$this->data['tempTables'] = $tempTables;
        //echo "<pre>";var_dump($tables);die;
