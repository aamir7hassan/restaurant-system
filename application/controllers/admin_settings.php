...
class Admin_Settings extends App_Controller
{
    ...
    public function index()
    {
        ...
        $this->assets_js     = array('jquery.dataTables.js', 'dataTables.bootstrap.js','switchery.min.js');
		...
		$accounts = $this->dev_model->getData('accounts','row_array',$args=['where'=>['sku'=>rtrim($this->config->item('SITE_ID'),'_')]]);
    ...
    public function info()
    {
		...
		$account = $this->dev_model->getData('accounts','row_array',$args=['where'=>['sku'=>rtrim($this->config->item('SITE_ID'), '_')]]);
        $this->render_page('admin/settings/info', array('current' => 'info','account'=>$account));
    }
