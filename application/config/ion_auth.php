...
$config['waiter_index']   = 3;
$config['customer_index'] = 4;
$config['waiter_text']    = 'waiter';
$config['admin_text']     = 'admin';
$config['owner_text']     = 'owner';
$config['customer_text']  = 'customer';
/*
| -------------------------------------------------------------------------
| MongoDB Collection.
| -------------------------------------------------------------------------
...
if ( isset($_SERVER["REQUEST_URI"]) && stripos($_SERVER["REQUEST_URI"],'/waiters/login') !== FALSE) { 
...
$config['max_password_length']        = 250;                  // Maximum Allowed Length of Password
