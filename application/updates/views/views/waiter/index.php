            ...
            <div class="container text-center col-lg-12">
                <div class="">
                    ...
                    <div class="row" id="sit">
                        ...
                        <div class="text-area">
                            <input type="number" id="table_id" name="table" placeholder="Enter table number" class="form-control" required="" value="<?php echo !empty($qr_id) ? $qr_id : $this->input->post('table'); ?>">
                        ...
                        <div class="text-area manager">
                            <input type="text" name="waiter_code" placeholder="Enter authorization code" class="form-control waiter_code" required>
                ...
                <div class="row" style="padding-left:15px;">
                    <div class="col col-md-7  col-xs-7">
                        <div class="row" style="padding-left:15px;">
                            ...
                            <h2 style="display: inline-block;padding-left:5px;padding-right:5px;"><img src="<?php echo base_url('assets/images/divider.png'); ?>" style="max-height: 34px;"></h2>
                            <h2 style="display: inline-block;"><a class="delivered-orders nav-link-item" href="<?php echo site_url('waiters/index/delivered') ?>">Delivered</a></h2>
                            <h2 style="display: inline-block;padding-left:5px;padding-right:5px;"><img src="<?php echo base_url('assets/images/divider.png'); ?>" style="max-height: 34px;"></h2>
                            <h2 style="display: inline-block;"><a class="waiting-orders nav-link-item" href="<?php echo site_url('waiters/index/waiting') ?>">Waiting</a></h2>
                ...
                <div class="col-md-6 col-sm-6">
                    <h1 class="table_header" style="margin-bottom:0 !important; height:52px;background: #3498db ;color:white;border-radius: 25px 25px 0px 0px;">
                        <div class="force_close" data-id="<?php echo $det['master_id']; ?>" data-userid="<?php echo $det['user_id']; ?>">
                            <img src="<?php echo base_url('assets/images/close2icn.png'); ?>" style="max-height: 48px;">
                        </div>

                        <span class="table_customer">
                            <?php echo 'L ' . $det['tname'] . ' | ' . $det['customer_name'][0]; ?>
                        </span>
                        ...
                        <div class="pull-right" style="padding-right: 30px;padding-top: 4px">
                            <a href="<?php echo site_url('waiters/email_slip/' . $det['master_id']) ?>">
                        ...
                        <div class="pull-right" style="padding-right: 40px;">
                            <a target="_blank" href="<?php echo site_url('waiters/print_item/' . $det['master_id']) ?>">
                                <img src="<?php echo base_url('assets/images/printicn.png'); ?>" style="max-height: 30px;">
                            </a>
                            <div class="clearfix">
                        </div>
                    </h1>
                    <div class="close_box text-justify" style="display:none;background:white;height:250px;text-align: center;">
                        ...
                        <div class="row" style="padding:10px;">
                            <button type="button" name="close_table" data-name="<?php echo $det['tname']; ?>" data-id="<?php echo $det['master_id']; ?>" data-userid="<?php echo $det['user_id']; ?>" class="btn btn-danger btn-large close_table">CLOSE TABLE</button>
                        </div>

                        <?php if ($package->packages != 'Option 2' && $package->packages != 'Option 3'){ ?>
                            <div class="row" style="padding:10px;">
                                <button type="button" name="point_of_sale" data-name="<?php echo $det['tname']; ?>" data-id="<?php echo $det['master_id']; ?>" data-userid="<?php echo $det['user_id']; ?>" class="btn btn-danger btn-large point_sale" data-toggle="modal" data-target="#calculator_view">POINT OF SALE</button>
                            </div>

                            <div class="row" style="padding:10px;">
                                <button type="button" name="point_of_sale" data-id="<?php echo $det['master_id']; ?>" data-userid="<?php echo $det['user_id']; ?>" class="btn btn-danger btn-large point_sale" data-toggle="modal" data-target="#view_bill">VIEW BILL</button>
                            </div>
                        <?php } ?>
                    </div>
                    <div class="details" style="background:#272323CC; color: #FFFFF;">
                        <?php if (isset($det['meal']) && count($det['meal']) > 0) : ?>
                                    ...
                                    <?php if ($det['status'] == 'paybill') { ?>
                                        <li class="" style="color:#FFFFFF; background: #FF0000;">
                                            ...
                                            <div class="col-xs-3">
                                                ...
                                                <button style="font-size:12px;" name="point_of_sale" data-name="<?php echo $det['tname']; ?>" data-id="<?php echo $det['master_id']; ?>" data-userid="<?php echo $det['user_id']; ?>" class="btn btn-confirm-user-payment point_sale" data-toggle="modal" data-target="#calculator_view">Cash Up</button>
                                            </div>
                                            <div class="clearfix"></div>
                                        </li>
                                    <?php } ?>
                            ...
                            <button type="button" name="close_table" data-name="<?php echo $det['tname']; ?>" data-id="<?php echo $det['master_id']; ?>" data-userid="<?php echo $det['user_id']; ?>" class="btn btn-large close_table" style="background-color: transparent;">CLOSE TABLE</button>
                                            </div>
                                            <div class="clearfix"></div>
                                        </li>
                                    <?php endif; ?>
                                    ...
                                    <?php foreach ($det['meal'] as $k => $data) : ?>
                                        <?php if (!empty($data)) { ?>
                                            <?php
                                                ...
                                                else if ($det['processed'][$k] == 2 && $proce_time < 25)
                                                    $li_class_color = 'dark';
                                                else if ($det['processed'][$k] == 2 && $proce_time >= 25)
                                                    $li_class_color = 'flash_red';
                                                else if ($det['processed'][$k] == 0 && $ordered_time >= 5)
                                                    $li_class_color = 'flash_blue';
                                                else if ($det['processed'][$k] == 0 && $ordered_time < 5)
                                                    $li_class_color = 'green';
                                            ?>
                                            ...
                                            <form id="<?php echo $det['oid'][$k]; ?>">
                                                <li class="order order_process <?php echo $li_class_color; ?>" style="color:#FFFFFF" id="<?php echo $det['oid'][$k]; ?>" data-oid="<?php echo $det['oid'][$k]; ?>">
                                                    ...
                                                    <p class="col-xs-10 order-contents" id="<?php echo $det['oid'][$k]; ?>" data-oid="<?php echo $det['oid'][$k]; ?>">
                                                        <?php echo $data . ' (' . time_took($det['time'][$k], $det['ptime'][$k]) . ')'; ?>
                                                        <br />
                                                        <?php echo !empty($det['comment'][$k]) ? '<br/>Comment: ' . $det['comment'][$k] . '' : ''; ?>
                                                        <?php echo !empty($det['customer_name'][$k]) ? '<br/>Ordered by: ' . $det['customer_name'][$k] . '' : ''; ?>
                                                    </p>
                                                    <div class="col-xs-2">
                                                        <div style="padding-left:30px" class="close-order" data-oid="<?php echo $det['oid'][$k]; ?>"><img src="<?php echo base_url('assets/images/close1icn.png'); ?>" style="max-height: 28px;"></div>
                                                    </div>
                                                    <div class="clearfix"></div>
                                                </li>
                                            </form>
            ...
            <?php if (isset($notices) && is_array($notices)) : ?>
                <?php foreach ($notices as $notice) : ?>
                    <div class="notice close_notice" style="cursor:pointer;" data-id="<?php echo $notice->id; ?>">
                        <?php echo $notice->message . ' ' . $notice->table_id; ?> (<?php echo time_took($notice->date, Date('Y-m-d H:i:s')); ?>) <div data-id="<?php echo $notice->id; ?>" class="pull-right glyphicon glyphicon-eye-close close_notice" style="cursor:pointer;"></div>
                        <div class="clearfix"></div>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
                        ...
                        if (result.status == 1) {
                            ...
                            orders.forEach(function(element) {
                                ...
                                html_items += '<div class="col-md-6">' + element.mname +
                                    ...
                                    '</div>';
                                total_vat += parseFloat(element.meal_price) * vat;
