                ...
                <div class="panel-body">
                    <div class="table-responsive">
                        <?php if(count($shift_data) > 0): ?>
                            <?php $subtotal = 0; $card_payment = $cash_payment = $card_price = $cash_price = $card_tip = $cash_tip = $total_tip = 0; ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <p>R<?php echo price_calc($subtotal); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <br/>
                                    <p>R<?php echo price_calc($cash_price); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <br/>
                                    <p>R<?php echo price_calc($card_price); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <p>R<?php echo price_calc($cash_tip); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <p>R<?php echo price_calc($card_tip); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4">
                                    <p><strong>R<?php echo price_calc($card_tip); ?></strong></p>
                                </div>
                            </div>
