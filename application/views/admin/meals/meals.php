                        ...
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                            <thead>
                                <tr>
                                    ...
                                    <th>Category</th>
                                    <th>Out of stock</th>
									<!--<th>Show Available Stock</th>
									<th>Hide Stock when 0</th>-->
                                    <th>Active</th>
                                    <th>Sort order</th>
                                    <th>Created</th>
                                    <th>Action</th>
                            ...
                            <tbody> 
                                ...
                                <?php foreach ($meals as $key => $meal): ?>
                                    <tr class="<?php ($key%2 == 0) ? 'odd' : 'even'; ?> gradeX">
										...
										<!--<td>
                                            <div class="btn-group">
                                                <?php if($meal->show_available == "1"): ?>
                                                    <a title="Active" href="<?php echo site_url('admin/meals/show_available/'.$meal->id); ?>" class="btn btn-micro active success"><span class="glyphicon glyphicon-ok"></span></a>															
                                                <?php else: ?>
                                                    <a title="Inactive" href="<?php echo site_url('admin/meals/show_available/'.$meal->id); ?>" class="btn btn-micro active success"><span class="glyphicon glyphicon-remove"></span></a>															
                                                <?php endif; ?>
                                            </div>
                                        </td>
										<td> 
											<?php $hideCheck = $meal->hide_stock=="1"?"checked":"";?>
											<input type="checkbox" name="hide_stock" value="0" />
											<input type="checkbox" name="hide_stock" id="hide_stock" <?=$hideCheck?> value="1" />
										</td>-->
                                        <td>
                                            <div class="btn-group">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-default btn-sm" data-dismiss="modal" style="color: #fff;">No</button>
                </div>
            </div>
        </div>
    </div>
