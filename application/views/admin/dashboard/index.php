    ...
    <form class="form-inline" method="post">
        <div class="col-sm-5 col-md-5">
            <div class="row">
                <div class="col-md-4"><h3 style="float:right; margin-top: 0;">Search By:</h3></div>
        ...
        <div class="col-sm-3 col-md-3">
            <form class="form-inline" method="post">
                <div class="form-group">
                    ...
                    <input type="text" name="date_to" data-provide="datepicker" class="form-control datepicker" id="date_to" value="<?php echo isset($_POST['date_to']) ? $_POST['date_to'] : ''; ?>" autocomplete="off">
                </div>
        </div>
		<div class="col-sm-1 col-md-1"><button type="submit" class="btn btn-default">Submit</button></div>
