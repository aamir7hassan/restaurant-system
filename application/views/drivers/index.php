    ...
    <?php } ?>
        ...
        <div class="header " style="max-height: 70px;background: #3498db;color:white;">
            <div class="col col-md-3 col-xs-3" style="max-height: 70px">
                <?php if ($this->config->item("store_logo")) : ?>
                    <img src="<?php echo base_url('assets/images/' . $this->config->item("store_logo")); ?>" style="max-height: 64px;" class="img-responsive imr" />
                <?php else : ?>
                    <img src="<?php echo base_url('assets/images/ResturantLogo.jpg'); ?>" style="max-height: 64px;" class="imr">
                <?php endif; ?>
            </div>

            <?php $user = $this->ion_auth->user()->row(); ?>
            <div class="col col-md-3 col-sm-6 col-xs-6 hidden-sm hidden-xs">
            ...
            <div class="col col-md-5 col-sm-12 col-xs-12">
                <div class="row" style="padding-left:15px;">
                    ...
                    <div class="col col-md-5  col-xs-12">
                        <div class="row r1s"  style="margin-left:5px;padding-left:5px;">
			...
			<div class="col-md-12" id="maparea">
				...
				<div class="row">
					<div class="col-md-6 col-sm-6 col-xs-6">
						<a href="<?=site_url('drivers/map')?>" id="map" target="_blank"  class="btn btn-lg btn-success text-right mhide">Map</a>
                                        ...
                                        <?php if (!empty($data)) {
                                            ...
                                            <form id="<?php echo $det['oid'][$k]; ?>">
                                                <li class="order order_process <?php echo $li_class_color; ?>" style="color:#FFFFFF" id="<?php echo $det['oid'][$k]; ?>" data-oid="<?php echo $det['oid'][$k]; ?>">
                                                    ...
                                                    <div class="col-xs-12 order-contents" data-processed = "<?php echo $det['processed'][$k]; ?>" id="<?php echo $det['oid'][$k]; ?>" data-oid="<?php echo $det['oid'][$k]; ?>">
		...
		<tbody>
			<?php
				...
				if (is_array($attribute_datas) && count($attribute_datas) > 0) {
					...
					foreach ($ar as $at=>$attrs) { 
						$back = '<p style="margin-top:2px"><i data-processed="'.$det["processed"][$k].'" data-oid="'.$det["oid"][$k].'" class="fa fa-long-arrow-left back-step" style="border:1px solid white;border-radius:50px;margin-top:10px !important;padding:4px;display:inline" title="Back Stage"></i></p>';
					if($at==0) { 
						$catN = "Category";
						$catV = $det['category'][$k];
						$close ='<div style="padding-left:45px;display:inline-block" class="close-order pull-right" data-processed = "'.$det["processed"][$k].'" data-oid="'.$det["oid"][$k].'"><img src="'.base_url("assets/images/close1icn.png").'" style="max-height: 28px;display:inline-block"></div>';
			...
			?>
				...
				<?php 
					if($Count == ($at+1)) { ?>
					<tr>
						<th><p style="margin-top:2px"><i data-processed="<?=$det['processed'][$k]?>" data-oid="<?=$det['oid'][$k]?>" class="fa fa-long-arrow-left back-step" style="border:1px solid white;border-radius:50px;margin-top:10px !important;padding:4px;display:inline" title="Back Stage"></i></p></th>
						<td></td>
						<th></th>
						<td></td>
			...
			<?php } else { ?>
				<tr>
					...
					<th></th>
					<td></td>
					<td><div style="padding-left:45px;display:inline-block" class="close-order pull-right" data-processed = "<?php echo $det['processed'][$k]; ?>" data-oid="<?php echo $det['oid'][$k]; ?>"><img src="<?php echo base_url('assets/images/close1icn.png'); ?>" style="max-height: 28px;display:inline-block"></div></td>
				</tr>
				<tr>
