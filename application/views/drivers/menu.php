                                        ...
                                        <?php echo form_open('', array('class' => 'form-'.$k)); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 nopadding">
                                                        ...
                                                        <button data-category="<?php echo $det['cname']; ?>" class="addit button" data-radid="<?=$radId?>" data-radval="<?=$radVal?>" data-id="<?php echo $k; ?>" data-exist="<?php echo in_array($k, $order) ? 'yes' : 'no'; ?>"><span class="glyphicon glyphicon-plus"></span>Order Now</button>
