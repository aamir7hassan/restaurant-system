...
<div class="container text-center col-lg-12">
    ...
    <div class="row">
        ...
        <div class="col-xs-6 grey">
            <span class="table_name">
                ...
                <br/><br/>
                <a href="<?php echo site_url('waiters') ?>" class="btn btn-danger btn-sm pull-right">Home</a>
                <br/>
            </span>
                                        ...
                                        <?php echo form_open('', array('class' => 'form-'.$k)); ?>
														...
														?>
                                                            <div class="attr_area">
                                                                ...
                                                                <p>
                                                                    ...
                                                                    <?php else: ?>
                                                                        <input class="radio_class" data-prc="<?=$k?>" data-radio="<?=$v->price?>" type="radio" name="attr[<?php echo $value['id'] ?>]" value="<?php echo $v->name ?>"><?php echo $v->name.$price_details ; ?>
                                                                    <?php endif; 
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 nopadding">
                                                        ...
                                                        <button data-category="<?php echo $det['cname']; ?>" class="addit button" data-radid="<?=$radId?>" data-types="<?=$types;?>" data-radval="<?=$radVal?>" data-id="<?php echo $k; ?>" data-exist="<?php echo in_array($k, $order) ? 'yes' : 'no'; ?>"><span class="glyphicon glyphicon-plus"></span>Order Now</button>
                                        ...
                                        <?php echo form_open('', array('class' => 'form-'.$k)); ?>
													...
													?>
                                                        <?php foreach ( $attribute[$k] as $attr_text => $value):
                                                            ...
                                                            <div class="attr_area">
                                                                ...
                                                                <p>
                                                                    <?php if( $value['type'] == 'multi'): ?>
                                                                        <input class="radio_class" data-prc="<?=$k?>" data-radio="<?=$v->price?>" <?php echo $value['required'] == 1 ? 'required' : '' ?> type="checkbox" name="attrs[<?php echo $value['id'] ?>][]" value="<?php echo $v->name ?>"><?php echo $v->name.$price_details ; ?>
                                                                    <?php else: ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-6 nopadding">
                                                        ...
                                                        <button data-category="<?php echo $det['cname']; ?>" class="addit button" data-radid="<?=$radId1?>" data-types="<?=$types1?>" data-radval="<?=$radVal1?>" data-id="<?php echo $k; ?>" data-exist="<?php echo in_array($k, $order) ? 'yes' : 'no'; ?>"><span class="glyphicon glyphicon-plus"></span>Order Now</button>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
           ...
           $(".menu_sub > li").click(function(){
            ...
            $(document).on('click', '.addit', function(e){
			   ...
			   data.push({name: 'temp_user', value: '<?=$user_id?>'});
		...
		//setInterval(showOrderNotify,10000);
