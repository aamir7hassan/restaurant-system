...
<body onload="window.print();">
    <div id='printContainer'>
        ...
        <p class="text-center address">
            VAT NO. <?php echo ($this->config->item('vat_number')); ?>
        </p>
        <p class="text-center address">
        ...
        <table style="width: 100%">
            ...
            <tr>
                ...
                <td><span style="font-size: 13px; padding-top: 20px"><?php echo CURRENCY_CODE;?> <?php echo $ord->tip; ?></span></td>
            </tr>
			<?php 
				$deliver =0;
			if($this->config->item('delivery_show') == '1' && $ord->type == "delivery") {
				$deliver = $this->config->item('delivery_fee');
			?>
			<tr>
                <td><span style="font-size: 13px; padding-top: 20px"></span></td>
                <td><span style="font-size: 13px; padding-top: 20px">Delivery Fee</span></td>
                <td><span style="font-size: 13px; padding-top: 20px"><?php echo CURRENCY_CODE;?> <?php echo $deliver; ?></span></td>
            </tr>
			<?php }?>
            ...
            <tr>
                ...
                <?php foreach($order_tot_price as $order_tot_pric):?>
                    ...
                    <td><span style="font-size: 13px; padding-top: 20px"><?php echo CURRENCY_CODE;?> <?php echo number_format($order_tot_pric->price  + $ord->tip +$deliver,2); ?></span></td> 
                <?php endforeach; ?>
            </tr> 
            ...
            <tr>
                <?php if($ord->payment_method == 1){ ?>
                    <td><span style="font-size: 13px;">CASH</span></td>
                <?php }else if($ord->payment_method == 2){?>
