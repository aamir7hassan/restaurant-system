                ...
                <div class="">
                    ...
                    <div class="row" id="take" style="display: none">
						...
						<div class="row">
							...
							</ul><?php $attributes = array('id' => 'new_customer_take');
                        echo form_open('waiters/index', $attributes); ?>
							<div class="tab-content">
								<div id="dell" class="tab-pane fade in active"><br/>
									<div class="text-area">
									...
									<div class="text-area">
										...
										<input type="text" name="address" id="address" autocomplete="off" placeholder="Address" class="form-control clc" required="" value="<?php echo $this->input->post('address') ? $this->input->post('address') : ''; ?>">
									...
									<?php if($this->config->item('delivery_show')=="1") { ?>
									<div class="text-area">
										<div class="input-group">
                ...
                <div class="row" style="padding-left:15px;">
                    <div class="col col-md-7  col-xs-7">
                        <div class="row" style="padding-left:15px;">
                            ...
                            <h2 style="display: inline-block;padding-left:5px;padding-right:5px;"><img src="<?php echo base_url('assets/images/divider.png'); ?>" style="max-height: 34px;"></h2>
							<?php if($this->config->item('driver')=="1") { ?>
    ...
    <div class="content_area">
        <div class="row">
			...
			foreach ($details as $key => $det) : 
					...
					$k = $orders[$kk]->budget;
					if($k > 0) {
						$bgtt ='<p class="text-center" >Available budget R: '.$k.'</p>';
					} else {
						$bgtt = '';
					}
                    ...
                    <h1 class="table_header" style="margin-bottom:0 !important; height:52px;background: #3498db ;color:white;border-radius: 25px 25px 0px 0px;">
                        ...
                        <div class="pull-right" style="padding-right: 30px;padding-top: 4px">
							...
							<?php if ($package->packages != 'Option 2' && $package->packages != 'Option 3'){ ?>
                                <a href="#" name="point_of_sale" data-name="<?php echo $det['tname']; ?>" data-id="<?php echo $det['master_id']; ?>" data-userid="<?php echo $det['user_id']; ?>"  data-toggle="modal" data-target="#calculator_view" class="point_sale"><i class='fa fa-shopping-cart' style="font-size: 22px;"  data-toggle="tooltip" data-placement="right" title="Point of Sale"></i></a>
                        <?php } ?>
                        </div>
						<?php 
                                    ...
                                    <?php if ($det['status'] == 'paybill') { ?>
                                        <li class="" style="color:#FFFFFF; background: #FF0000;">
                                            ...
                                            <div class="col-xs-3">
                                                ...
                                                <button style="font-size:12px;" name="point_of_sale" data-name="<?php echo $det['tname']; ?>" data-id="<?php echo $det['master_id']; ?>" data-userid="<?php echo $det['user_id']; ?>" class="btn btn-confirm-user-payment point_sale poss" data-toggle="modal" data-target="#calculator_view">Cash Up</button>
                                            </div>
                                            <div class="clearfix"></div>
                                        </li>
                                    <?php } ?>
                                        ...
                                        <?php if (!empty($data)) {
                                            ...
                                            <form id="<?php echo $det['oid'][$k]; ?>">
                                                <li class="order order_process <?php echo $li_class_color; ?>" style="color:#FFFFFF" id="<?php echo $det['oid'][$k]; ?>" data-oid="<?php echo $det['oid'][$k]; ?>">
                                                    ...
                                                    <div class="col-xs-1"> 
                                                        <div style="padding-left:45px;display:inline-block" class="close-order pull-right" data-oid="<?php echo $det['oid'][$k]; ?>">
															<img src="<?php echo base_url('assets/images/close1icn.png'); ?>" style="max-height: 28px;display:inline-block">
														</div>
														
                                                    </div>
													<div class="col-xs-1">
														<p style="margin-top:2px"><i data-processed="<?=$det['processed'][$k]?>" data-oid="<?=$det['oid'][$k]?>" class="fa fa-long-arrow-left back-step" style="border:1px solid white;border-radius:50px;margin-top:10px !important;padding:4px;display:inline" title="Back Stage"></i></p>
													</div>
		...
		$(document).on('click','.back-step',function(){
			...
			if(processed == 0 ) {
				...
				$.ajax({
					...
					method: "POST",
					data: {'processed':processed,'oid':oid},
					dataType: "JSON",
					beforeSend:function(){
						$('.ajax-loader').css("visibility", "visible");
					},
